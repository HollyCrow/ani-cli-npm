# ⚠️This tool is currently broken. [Ani-cli](https://github.com/pystardust/ani-cli) has a fix for this, but I have not got around to fixing it here yet. Working on it currently, but may take a while.
